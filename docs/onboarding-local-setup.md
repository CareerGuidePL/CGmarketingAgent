...
Po uruchomieniu n8n — czekaj na workflowy dostarczane przez prowadzącego projekt. Będą udostępniane jako pliki JSON do importu:

`n8n → górne menu → Import from file`
